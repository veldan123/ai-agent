...
# ── Download agent ──
echo "  Downloading AI Script Writer..."
mkdir -p ~/script_writer
curl -fsSL "https://raw.githubusercontent.com/veldan123/ai-agent/main/script_writer/agent.py" -o ~/script_writer/agent.py
echo "  ✓ Ready"

echo ""
echo "  ✓ Done! Launching AI Script Writer..."
echo ""
python3 ~/script_writer/agent.py || {
    echo ""
