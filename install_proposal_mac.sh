...
echo ""
echo "  ╔══════════════════════════════════════╗"
echo "  ║  Proposal & Quote Writer — Mac Setup  ║"
echo "  ╚══════════════════════════════════════╝"
echo ""
...
# ── Download agent ──
echo "  Downloading Proposal & Quote Writer..."
mkdir -p ~/proposal_writer
curl -fsSL "https://raw.githubusercontent.com/veldan123/ai-agent/main/proposal_writer/agent.py" -o ~/proposal_writer/agent.py
echo "  ✓ Ready"

echo ""
echo "  ✓ Done! Launching Proposal & Quote Writer..."
echo ""
python3 ~/proposal_writer/agent.py || {
    echo ""
